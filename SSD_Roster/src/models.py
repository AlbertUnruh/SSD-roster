...
class UserModel(DBBaseModel):
    ...
    user_id: Mapped[UserID] = Column(Integer, primary_key=True, unique=True, autoincrement=True, nullable=False)
    username: Mapped[str] = Column(Text, unique=True, nullable=False)
    displayed_name: Mapped[str] = Column(Text, nullable=False)
    email: Mapped[EmailStr] = Column(Text, unique=True, nullable=False)
    email_verified: Mapped[bool] = Column(Boolean, nullable=False)
    user_verified: Mapped[bool] = Column(Boolean, nullable=False)
    birthday: Mapped[PastDate] = Column(Date, nullable=False)
    password: Mapped[Optional[SecretStr]] = Column(Text, nullable=True)
    scopes: Mapped[str] = Column(Text, nullable=False)
...
class RosterModel(DBBaseModel):
    ...
    roster_id: Mapped[int] = Column(Integer, primary_key=True, unique=True, autoincrement=True, nullable=False)
    year: Mapped[Year] = Column(Integer, nullable=False)
    week: Mapped[Week] = Column(Integer, nullable=False)
    published: Mapped[bool] = Column(Boolean, nullable=False)
    published_by: Mapped[UserID] = Column(Integer, nullable=False)
    published_at: Mapped[datetime] = Column(DateTime, nullable=False)
    mo_s1p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s1p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s1p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s2p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s2p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s2p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s3p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s3p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_s3p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_bp1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_bp2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    mo_bp3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s1p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s1p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s1p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s2p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s2p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s2p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s3p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s3p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_s3p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_bp1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_bp2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    tu_bp3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s1p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s1p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s1p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s2p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s2p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s2p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s3p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s3p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_s3p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_bp1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_bp2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    we_bp3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s1p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s1p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s1p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s2p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s2p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s2p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s3p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s3p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_s3p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_bp1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_bp2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    th_bp3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s1p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s1p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s1p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s2p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s2p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s2p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s3p1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s3p2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_s3p3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_bp1: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_bp2: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
    fr_bp3: Mapped[Optional[UserID]] = Column(Integer, nullable=True)
...
class TimetableModel(DBBaseModel):
    ...
    timetable_id: Mapped[int] = Column(Integer, primary_key=True, unique=True, autoincrement=True, nullable=False)
    user_id: Mapped[UserID] = Column(Integer, nullable=False)
    year: Mapped[Year] = Column(Integer, nullable=False)
    week: Mapped[Week] = Column(Integer, nullable=False)
    mo_s1: Mapped[Availability] = Column(Integer, nullable=False)
    mo_s2: Mapped[Availability] = Column(Integer, nullable=False)
    mo_s3: Mapped[Availability] = Column(Integer, nullable=False)
    mo_b: Mapped[Availability] = Column(Integer, nullable=False)
    tu_s1: Mapped[Availability] = Column(Integer, nullable=False)
    tu_s2: Mapped[Availability] = Column(Integer, nullable=False)
    tu_s3: Mapped[Availability] = Column(Integer, nullable=False)
    tu_b: Mapped[Availability] = Column(Integer, nullable=False)
    we_s1: Mapped[Availability] = Column(Integer, nullable=False)
    we_s2: Mapped[Availability] = Column(Integer, nullable=False)
    we_s3: Mapped[Availability] = Column(Integer, nullable=False)
    we_b: Mapped[Availability] = Column(Integer, nullable=False)
    th_s1: Mapped[Availability] = Column(Integer, nullable=False)
    th_s2: Mapped[Availability] = Column(Integer, nullable=False)
    th_s3: Mapped[Availability] = Column(Integer, nullable=False)
    th_b: Mapped[Availability] = Column(Integer, nullable=False)
    fr_s1: Mapped[Availability] = Column(Integer, nullable=False)
    fr_s2: Mapped[Availability] = Column(Integer, nullable=False)
    fr_s3: Mapped[Availability] = Column(Integer, nullable=False)
    fr_b: Mapped[Availability] = Column(Integer, nullable=False)
...
class ScopeModel(DBBaseModel):
    ...
    scope: Mapped[str] = Column(Text, primary_key=True, unique=True, nullable=False)
    group_: Mapped[str] = Column(Text, nullable=False)


class VerificationCodesModel(DBBaseModel):
    __tablename__ = "verification_code"

    user_id: Mapped[int] = Column(Integer, primary_key=True, unique=True, autoincrement=False, nullable=False)
